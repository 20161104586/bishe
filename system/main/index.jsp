	...
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main mag0">
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" id="userInfo">
						<a href="javascript:;"><img src="${ctx}/resources/images/begin.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">${user.realname }</cite></a>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="${ctx}/resources/images/begin.jpg" class="userAvatar"></a>
		...
		<div class="layui-footer footer">
			<p><span>copyright @2020 马德辉</span></p>
		</div>
	</div>
